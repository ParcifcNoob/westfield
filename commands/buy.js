...
exports.execute = async (client, message, args) => {
  ...
  if (!isBalanceEnough) return message.reply("Your balance is insufficient. You need £"+hasItem.cost+" to buy this item.");
  ...
  return message.channel.send(`You purchased **${item}** for **£${hasItem.cost}**.`);
};
